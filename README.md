...
- **Összetett (#complex) mérték:** illesztve (komponensek feloldása + összefűzés). Strófa-szintű illesztés még nincs.
...
- A rímdetektor a sorvégeket veszi (közelítés); rímtelen szövegen előfordulhat vél-klaszterezés.# Kalliopé
